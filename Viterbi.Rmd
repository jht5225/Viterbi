...
Next, we make our transition matrix. This is done by finding the counts of all the bigrams of parts of speech and dividing by the occurance of the first one.
...
Now that we have our counts, we perform opperations to get probabilities.
...
Finally, we make our emmission probabilities
